...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-file', type=str, default="resume_rand32_over80_fixed_err0.01_800k_seed2", metavar='S',
    ...
    try:
        ...
        if cfg.log_wandb:
            wandb.init(
                ...
                name="resume_rand32_over80_fixed_err01_seed2",
        ...
        iteration = [630000]#00,5000,25000]
